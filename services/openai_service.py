...
class OpenAIService:
    ...
    def enhance_search_query(self, query: str, user_context: dict | None = None) -> dict[str, Any]:
        """
    ...
    async def generate_chat_response(self, prompt: str, system_message: str | None = None) -> str:
        """
