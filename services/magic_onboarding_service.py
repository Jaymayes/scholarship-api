...
from models.onboarding import (
    OnboardingStage, OnboardingQuestion, QuestionType,
    MagicOnboardingSession, ConversationalContext,
    OnboardingStartRequest, OnboardingContinueRequest,
    OnboardingResponse, ProfileCompletionStatus,
    SmartProfileSuggestion, ProfileUpdateRequest
)
...
class MagicOnboardingService:
    ...
    def _get_next_question(self, session: MagicOnboardingSession) -> Optional[OnboardingQuestion]:
    ...
    def _generate_profile_insights(self, session: MagicOnboardingSession) -> Optional[Dict[str, Any]]:
