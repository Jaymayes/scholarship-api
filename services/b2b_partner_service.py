...
from models.b2b_partner import (
    ...
    PartnerSupportTicket, PartnerPortalSession,
    PartnerType, PartnerStatus, VerificationStatus,
    DEFAULT_ONBOARDING_STEPS, SUPPORT_TIERS
)
...
class PartnerVerificationService:
    ...
    @staticmethod
    async def verify_nonprofit_status(tax_id: str) -> Optional[bool]:
...
class B2BPartnerService:
    ...
    async def get_marketplace_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for partner_id, steps in self.onboarding_steps.items():
    ...
    async def _assign_support_ticket(self, ticket: PartnerSupportTicket, support_tier: str) -> Optional[str]:
