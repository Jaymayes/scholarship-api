...
from models.document_hub import (
    DocumentType, ProcessingStatus, DocumentFormat,
    DocumentUploadRequest, DocumentUploadResponse,
    AIDocumentProcessingResult, DocumentRetrievalResponse,
    ExtractedAcademicData, ExtractedPersonalData, 
    ExtractedFinancialData, ExtractedActivitiesData,
    DocumentMetadata, BulkDocumentAnalysis
)
...
class DocumentHubService:
    ...
    async def _extract_academic_data(self, text: str) -> Optional[ExtractedAcademicData]:
    ...
    async def _extract_personal_data(self, text: str) -> Optional[ExtractedPersonalData]:
    ...
    async def _extract_activities_data(self, text: str) -> Optional[ExtractedActivitiesData]:
