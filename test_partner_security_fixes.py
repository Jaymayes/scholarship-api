...
class SecurityTestSuite:
    ...
    async def get_auth_token(self, username: str = "admin", password: str = "admin123") -> str | None:
    ...
    async def test_authorized_access(self, endpoint: str, token: str, method: str = "GET", expected_status: int = 200, data: dict | None = None) -> bool:
