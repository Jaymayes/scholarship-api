...
from models.database import ProviderDB
...
class ARRTarget:
    ...
    special_milestone: str | None = None  # Case studies, enterprise commits
...
class PricingPackage:
    ...
    acv_target: Decimal | None = None  # Annual Contract Value target
...
class FunnelMetrics:
    ...
    avg_time_to_first_listing: float | None = None  # Target: ≤7 days
    avg_time_to_first_application: float | None = None  # Target: ≤14 days

    # Commercial metrics
    ltv_cac_ratio: float | None = None  # Target: ≥3:1
    pipeline_coverage: float | None = None  # Target: ≥3x
...
class B2BCommercialExecutionService:
    ...
    def generate_weekly_provider_engine_report(self, db: Session) -> dict[str, Any]:
        ...
        logger.info("📊 Weekly Provider Engine report generated")
