...
class ProviderProfile:
    ...
    time_to_first_listing: timedelta | None = None
    time_to_first_application: timedelta | None = None
    first_listing_date: datetime | None = None
    first_application_date: datetime | None = None
    ...
    dpa_signed_date: datetime | None = None
...
class B2BProviderAcquisitionService:
    ...
    def providers(self) -> dict[str, ProviderProfile]:
        ...
        try:
            provider_records = db.query(ProviderDB).filter(ProviderDB.is_active).all()
            result = {}
    ...
    def get_provider_api_key_for_display(self, provider_id: str) -> str | None:
    ...
    def regenerate_provider_api_key(self, provider_id: str) -> str | None:
    ...
    def _calculate_conversion_rate(self, from_status: ProviderStatus, to_status: ProviderStatus) -> float | None:
