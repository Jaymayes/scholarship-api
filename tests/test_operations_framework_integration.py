...
from services.lead_routing_engine import (
    lead_routing_engine, LeadSegment, Territory, LeadSource, 
    LeadStage, AssignmentType
)
from services.pipeline_management_system import (
    pipeline_management_system, DealStage, DealHealth
)
...
from services.performance_dashboards import (
    performance_dashboard_system, TimeRange
)
...
def run_integration_tests():
    ...
    try:
        ...
        workflow_results = test_instance.test_end_to_end_workflow()
        unified_analytics = test_instance.test_unified_analytics()
