...
**Timestamp**: 2026-01-20T20:46:00Z  
**Gate**: 3 (50% Traffic)
...
|----------|----------|--------|
| Verification Samples | tests/perf/evidence/verification_samples.json | (computed) |
| Raw Curl Evidence | tests/perf/evidence/raw_curl_evidence.txt | (computed) |
| Fee Lineage | tests/perf/evidence/fee_lineage.json | (computed) |
