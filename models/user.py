...
class UserProfile(BaseModel):
    ...
    id: str | None = Field(None, description="User identifier")
    gpa: float | None = Field(None, ge=0.0, le=4.0, description="Grade Point Average")
    grade_level: str | None = Field(None, description="Current grade level")
    field_of_study: FieldOfStudy | None = Field(None, description="Field of study")
    citizenship: str | None = Field(None, description="Citizenship status")
    state_of_residence: str | None = Field(None, description="State of residence")
    age: int | None = Field(None, ge=0, description="User age")
    financial_need: bool | None = Field(None, description="Has financial need")
...
class UserInteraction(BaseModel):
    ...
    scholarship_id: str | None = Field(None, description="Related scholarship ID")
