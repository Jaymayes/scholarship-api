...
class WAFProtection(BaseHTTPMiddleware):
    ...
    def __init__(self, app, enable_block_mode: bool = True):
        ...
        self._waf_bypass_paths = {
            ...
            "/day2/ab-test/event",  # Day-2 A/B test events (internal ops)
            "/day2/dashboard/provider-signup",  # Day-2 provider signup tracking (internal ops)
            "/day2/dashboard/gmv",  # Day-2 GMV tracking (internal ops)
            "/day2/experiment/event-attributed",  # SDR experiment attribution (internal ops)
            ...
            "/oca/canary/day2/load-resilience/step-stress",  # QA Orchestrator: Step-stress test (internal ops)
            "/oca/canary/day2/a7-pagemaker/record-p95",  # QA Orchestrator: A7 P95 recording (internal ops)
            "/oca/canary/day2/sdr/update-rep",  # QA Orchestrator: SDR rep update (internal ops)
