...
**Generated:** 2025-10-29 03:20:27 UTC
...
|-----|------|--------|------|-------|--------|
| Auto Com Center | internal_dashboard | ✅ | 102.13ms | 🟠 2/5 | HTTP 404 on root |
| Scholarship Agent | public_frontend | ✅ | 103.2ms | ✅ 5/5 | None |
| Scholarship Sage | public_frontend | ❌ | N/A | ❌ 0/5 | Connection failed - app not reachable |
| Scholarship API | api_service | ✅ | 244.36ms | ✅ 5/5 | None |
| Student Pilot | authenticated_frontend | ✅ | 94.15ms | ✅ 5/5 | None |
| Provider Register | public_frontend | ✅ | 77.83ms | ✅ 5/5 | None |
| Auto Page Maker | public_frontend | ✅ | 46.12ms | ✅ 5/5 | None |
| Scholar Auth | auth_service | ✅ | 51.44ms | ✅ 5/5 | None |
