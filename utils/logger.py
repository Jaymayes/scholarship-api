...
class APILogger:
    ...
    def log_request(self, method: str, path: str, user_id: str | None = None, **kwargs):
        """Log API request"""
    ...
    def log_response(self, method: str, path: str, status_code: int,
                    response_time_ms: float | None = None, **kwargs):
        """Log API response"""
    ...
    def log_error(self, method: str, path: str, error: Exception, user_id: str | None = None):
        """Log API error"""
        user_info = f" | User: {user_id}" if user_id else ""
        self.logger.error(f"API Error: {method} {path}{user_info} | Error: {str(error)}")

    def log_business_event(self, event: str, details: dict | None = None):
    ...
    def log_data_operation(self, operation: str, table: str | None = None, count: int | None = None, **kwargs):
        """Log data operations"""
